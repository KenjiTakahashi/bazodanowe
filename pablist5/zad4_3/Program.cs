    ...
    class Program {
        static ISessionFactory CreateSessionFactory() {
            return Fluently.Configure()
                .Database(FluentNHibernate.Cfg.Db.MsSqlConfiguration.MsSql2008.ConnectionString("Data Source=.;Initial Catalog=hid3;Integrated Security=true"))
        ...
        static void Main(string[] args) {
            ...
            using(ISession s = sf.OpenSession()) {
                ...
                s.Delete("from Worker w");
                s.Delete("from OutWorker o");
                s.Flush();
            }
            Console.ReadKey();
        }
